...
import org.mrutcka.wntw.RegistrationActivity;
...
public class DoneFragment extends ListFragment {
    ...
    private void getTasks() {
        try {
            ...
            if(connection != null) {
                String query_tasks =
                        "SELECT * from Tasks JOIN Tasks_Projects ON Tasks_Projects.TaskID = Tasks.TaskID WHERE Tasks_Projects.ProjectID = " + projectID + " AND Tasks.TaskCategory =" + '3';
